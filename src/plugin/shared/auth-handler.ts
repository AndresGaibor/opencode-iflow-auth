/**
 * Shared OAuth authorization handler for iFlow plugins
 ...
 * Works for both headless and browser environments
 */
...
/**
 * Save OAuth account to disk
 */
async function saveAccount(
  res: Awaited<ReturnType<typeof exchangeOAuthCode>>,
  config: IFlowConfig
): Promise<void> {
